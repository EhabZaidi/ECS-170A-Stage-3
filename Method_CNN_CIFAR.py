...
class Method_CNN_CIFAR(method, nn.Module):
    ...
    def __init__(self, mName, mDescription):
        ...
        self.fc_layer_1 = nn.Linear(128*4*4, 256)
        self.relu_4 = nn.ReLU()
    ...
    def train(self, X, y):
        ...
        plt.xlabel('Epoch')
        plt.ylabel('Loss')
        plt.title('CIFAR CNN Training Loss Convergence Curve')
        plt.savefig('cifar_cnn_training_loss_curve.png')
        plt.close()
        ...
        plt.xlabel('Epoch')
        plt.ylabel('Accuracy')
        plt.title('CIFAR CNN Training Accuracy Convergence Curve')
        plt.savefig('cifar_cnn_training_accuracy_curve.png')
        plt.close()
    ...
    def run(self):
        ...
        print('--start training CIFAR CNN...')
        self.train(self.data['train']['X'], self.data['train']['y'])
        print('--start testing CIFAR CNN...')
