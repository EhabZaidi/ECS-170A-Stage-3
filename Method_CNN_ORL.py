...
class Method_CNN_ORL(method, nn.Module):
    ...
    def __init__(self, mName, mDescription):
        ...
        self.fc_layer_1 = nn.Linear(32*28*23, 128)
        self.relu_3 = nn.ReLU()
    ...
    def train(self, X, y):
        ...
        plt.xlabel('Epoch')
        plt.ylabel('Loss')
        plt.title('ORL CNN Training Loss Convergence Curve')
        plt.savefig('orl_cnn_training_loss_curve.png')
        plt.close()
        ...
        plt.xlabel('Epoch')
        plt.ylabel('Accuracy')
        plt.title('ORL CNN Training Accuracy Convergence Curve')
        plt.savefig('orl_cnn_training_accuracy_curve.png')
        plt.close()
    ...
    def run(self):
        ...
        print('--start training ORL CNN...')
        self.train(self.data['train']['X'], self.data['train']['y'])
        print('--start testing ORL CNN...')
